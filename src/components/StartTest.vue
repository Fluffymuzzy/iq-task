<template>
    <div id="test-info" class="start__test-wrapper">
        <p class="start__test-text">Также по результатам теста
            ...
            <span>для вашего типа <span class="start__test-span">интеллекта</span>
                сферы
                деятельности,
            </span>
            которая принесет вам скорейший финансовый результат.
        </p>
        <img src="images/home/st-img.png" alt="brain" class="start__test-img">
        <Button buttonText="Пройти тест" buttonClass="start__test-btn" @click="goToTestPage" />
    </div>
</template>
